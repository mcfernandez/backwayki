...
export class UserEditComponent implements OnInit, OnDestroy {
	...
	getListRol() {
		...
		this._security.getList(url).subscribe((value: any) => {
			this.roles = value.filter(m => m.id == "037cf753-eeb9-47ba-890e-cb2b8df48486" || m.id == "64ee1313-e3f7-4dcd-b02e-2a913e86b28f" || m.id == "b46dd5ec-fa60-4f65-a13b-562bc008392b" || m.id == "7eaf8469-1541-498c-a322-86be56c0068e");
		});
	}
	...
	onSumbit(withBack: boolean = false) {
		if (this.password == this.password2) {
			...
			if (this.validar()) {
				...
				this._security.postUser(data).subscribe((res: any) => {
					if (res == true) {
						console.log(res);
						Swal.fire({
							icon: 'success',
							title: 'Creado',
							text: 'Usuario Insertado con exito',
						})
			...
			Swal.fire({
				icon: 'error',
				title: 'Error',
				text: "Las contraseñas no coincidennn"
			})
		}
